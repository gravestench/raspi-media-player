...
func Default() Config {
	return Config{
		...
		MetadataEnabled:     env("RASPI_MEDIA_PLAYER_METADATA_ENABLED", "true") == "true",
		MetadataCacheDays:   envInt("RASPI_MEDIA_PLAYER_METADATA_CACHE_DAYS", 7),
